...
/// Whether this channel is orchestrator-enabled (the server's
/// `IsInterceptorEnabled`). Gates `-[Subscription thread:]` and channel
/// storage; `Orchestrator` bypasses it via `threadUnchecked:`. Defaults
/// to NO.
