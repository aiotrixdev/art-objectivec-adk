...
- (id)copyWithZone:(NSZone *)zone {
    return [[CredentialStore allocWithZone:zone]
        initWithEnvironment:self.environment
                 projectKey:self.projectKey
                   orgTitle:self.orgTitle
...
- (id)copyWithZone:(NSZone *)zone {
    return [[AuthenticationConfig allocWithZone:zone]
        initWithEnvironment:self.environment
                 projectKey:self.projectKey
                   orgTitle:self.orgTitle
                   clientID:self.clientID
...
- (id)copyWithZone:(NSZone *)zone {
    return [[AuthData allocWithZone:zone] initWithAccessToken:self.accessToken
